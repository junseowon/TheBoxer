...
class SpriteObject:
    def __init__(self, game, path='sprites/static_sprites/street_light.png',
                 pos=(10.5, 3.5), scale=1.5, shift=-0.15):
        self.game = game
...
class AnimatedSprite(SpriteObject):
    def __init__(self, game, path='sprites/animated_sprites/emotion/0.png',
